        ...
        return (
          ...
          >
            ...
            >
              <div
                className={cn(
                  'size-5 flex items-center justify-center border-2 border-gray-900 rounded-full transition duration-300',
                  isSelected && 'border-blue-500',
                )}
              >
                <div
                  className={cn(
                    'size-2 scale-0 bg-blue-500 rounded-full transition',
              ...
              <div
                className={cn(
                  'size-2.5 bg-purple-500 opacity-0 rounded-full',
